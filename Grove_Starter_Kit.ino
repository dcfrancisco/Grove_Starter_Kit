...
// 30*30
const unsigned char anime_bmp[] U8X8_PROGMEM = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0xfc, 0x01, 0x00, 0x00, 0xfe, 0xff, 0xff, 0x07, 0xfe, 0xff, 0xff, 0x1f, 0x8f, 0xff, 0xff, 0x3f, 0x0f, 0x00, 0x00, 0x3e, 0x0f, 0x00, 0x00, 0x3e, 0x8f, 0xff, 0xff, 0x3f, 0xfe, 0xff, 0xff, 0x1f, 0xfe, 0xff, 0xff, 0x07, 0xfc, 0x01, 0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};

#define POTENTIOMRMETER_POS 170.7 // 204.8
        ...
        if (digitalRead(button) == HIGH)
        {
          ...
          while (1)
          {
            ...
            if (digitalRead(button) == HIGH)
            {
              ...
              if (digitalRead(button) == HIGH)
              {
                MODE = analogRead(rotary) / POTENTIOMRMETER_POS + 1;
                Serial.println(MODE);
                while (digitalRead(button))
                  ;
                digitalWrite(led, LOW);
...
void select_mode(int n)
{
  ...
  case 3:
    ...
    do
    {
      ...
      u8g2.drawXBMP(49, 0, 30, 30, anime_bmp);
